...
function WatchEntry ({watchedcoin, setDynamicCoin}) {
  ...
  return (
    <div style={{display: 'flex', flexDirection: 'row', margin: 'auto'}}>
      <div style={{marginLeft: '10%', marginTop: 'auto', marginBottom: 'auto', width: '50%', border: 'black solid', borderRadius: '10px', backgroundColor: 'black'}} onClick={()=>{setDynamicCoin(watchedcoin)}}>{watchedcoin[0]}</div>
